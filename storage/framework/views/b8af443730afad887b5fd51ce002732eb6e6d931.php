                    ...
                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel"
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                                <img class="d-block img-fluid" src="<?php echo e(URL::asset('/assets/images/small/img-1.jpg')); ?>"
                                    alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block img-fluid" src="<?php echo e(URL::asset('/assets/images/small/img-2.jpg')); ?>"
                                    alt="Second slide">
                            </div>
                            <div class="carousel-item">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                                <img class="d-block img-fluid" src="<?php echo e(URL::asset('/assets/images/small/img-4.jpg')); ?>"
                                    alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block img-fluid" src="<?php echo e(URL::asset('/assets/images/small/img-5.jpg')); ?>"
                                    alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block img-fluid" src="<?php echo e(URL::asset('/assets/images/small/img-6.jpg')); ?>"
                                    alt="Third slide">
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="carouselExampleCaption" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                                <img src="<?php echo e(URL::asset('/assets/images/small/img-7.jpg')); ?>" alt="..."
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\skote.test\resources\views/ui-carousel.blade.php ENDPATH**/ ?>